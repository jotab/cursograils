	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.lastUpdate}">
				<li class="fieldcontain">
					<span id="lastUpdate-label" class="property-label"><g:message code="usuario.lastUpdate.label" default="Last Update" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdate-label"><g:formatDate date="${usuarioInstance?.lastUpdate}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${usuarioInstance?.tweets}">
				<li class="fieldcontain">
					<span id="tweets-label" class="property-label"><g:message code="usuario.tweets.label" default="Tweets" /></span>
